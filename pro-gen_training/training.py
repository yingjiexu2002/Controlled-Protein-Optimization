...
#***************参数解析********************
parser = argparse.ArgumentParser(description='Finetuning code for generating from CTRL（微调代码）')
...
parser.add_argument('--model_path', type=str,
                    default='/home/amadani/ctrl/ckpt/seqlen256_36layers_v0.ckpt/model.ckpt-684000',
...
parser.add_argument('--lora_dim', type=int, default= 16, help='lora intrinsic dimension')
...
class Trainer(object):
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            # 遍历每一个数据块
            for chunknum in range(chunknums):
